...
export default function ConstructionCalculatorsPage() {
  const implementedCalculators = calculatorCategories["Construction and Building"].filter((calc) => calc.implemented)
    ...
    <div className="container py-12 space-y-12">
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center space-x-3">
          ...
          <h1 className="text-4xl font-bold">Construction & Building Calculators</h1>
        </div>
      ...
      {implementedCalculators.length > 0 ? (
            ...
            <Card key={calculator.name} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <Button asChild className="w-full">
                  <Link href={`/calculators/construction-and-building/${createUrlSlug(calculator.name)}`}>
                    Use Calculator
                  </Link>
                </Button>
              </CardContent>
        ...
        <div className="text-center py-16 bg-muted/30 rounded-lg">
          <Hammer className="h-16 w-16 mx-auto mb-6 opacity-50" />
          <h2 className="text-2xl font-bold mb-4">More Calculators Coming Soon!</h2>
          <p className="text-muted-foreground max-w-md mx-auto mb-6">
            We're actively developing new construction calculators to help with your building projects. Check back soon
            for tools like concrete footings, brick estimation, and more!
          </p>
      ...
      <div className="bg-muted/50 rounded-lg p-8 text-center space-y-4">
        ...
        <p className="text-muted-foreground">
          Our construction calculators use industry-standard formulas to ensure accurate results. Each calculator
          includes helpful tips and explanations.
        </p>
        <Button asChild variant="outline">
